...
public static class ServiceCollectionBuilderExtensions
{
    ...
    /// <summary>
    /// Adds Facebook authentication services to the IServiceCollection with the provided configuration.
    /// </summary>
    /// <param name="services">The IServiceCollection to add services to.</param>
    /// <param name="configure">An action to configure the SocialSettings.</param>
    /// <returns>The modified IServiceCollection.</returns>
    public static IServiceCollection AddFacebookServices(this IServiceCollection services, Action<SocialSettings> configure)
    {
        SocialSettings socialSettings = new();
        configure?.Invoke(socialSettings);
    ...
    /// <summary>
    /// Adds Google authentication services to the IServiceCollection with the provided configuration.
    /// </summary>
    /// <param name="services">The IServiceCollection to add services to.</param>
    /// <param name="configure">An action to configure the SocialSettings.</param>
    /// <returns>The modified IServiceCollection.</returns>
    public static IServiceCollection AddGoogleServices(this IServiceCollection services, Action<SocialSettings> configure)
    {
        services.Configure(configure);
        services.TryAddSingleton<IGoogleAuthService, GoogleAuthService>();
