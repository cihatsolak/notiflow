...
public interface IRestService
{
    ...
    /// <param name="route">The URL of the route to request</param>
    ...
    Task<TResponse> GetResponseAsync<TResponse>(string clientName, string route, CancellationToken cancellationToken) where TResponse : class, new();
    ...
    /// <returns>A Task object representing the asynchronous operation that returns the expected response type</returns>
    /// <exception cref="ArgumentNullException">thrown when http client type cannot be created</exception>
    Task<TResponse> PostResponseAsync<TResponse>(string clientName, string route, CancellationToken cancellationToken) where TResponse : class, new();
    ...
    /// <returns>A Task object representing the asynchronous operation that returns the expected response type</returns>
    /// <exception cref="ArgumentNullException">thrown when http client type cannot be created</exception>
    Task<TResponse> PatchResponseAsync<TResponse>(string clientName, string route, CancellationToken cancellationToken) where TResponse : class, new();
    ...
    /// <param name="route">The URL of the API endpoint to send the request to.</param>
