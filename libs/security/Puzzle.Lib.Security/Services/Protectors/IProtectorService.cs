...
public interface IProtectorService
{
    ...
    /// <param name="protectedData">The cipher text data to decrypt.</param>
    /// <returns>The decrypted plaintext data.</returns>
    TData Decrypt<TData>(string protectedData);
    ...
    /// <param name="protectedData">The cipher text data to decrypt.</param>
    /// <returns>The decrypted plaintext data.</returns>
    TData TimeDependentDecrypt<TData>(string protectedData);
}