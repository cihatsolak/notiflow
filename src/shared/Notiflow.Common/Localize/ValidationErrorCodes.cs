...
public class ValidationErrorCodes
{
    ...
    public const int PHONE_NUMBER = 1003;
    public const int EMAIL = 1004;
    public const int BIRTH_DATE = 1005;
    public const int GENDER = 1006;
    public const int MARRIAGE_STATUS = 1007;
    public const int CUSTOMER_ID = 1008;
    public const int OS_VERSION = 1009;
    public const int DEVICE_CODE = 1010;
    public const int DEVICE_TOKEN = 1011;
    public const int CLOUD_MESSAGE_PLATFORM = 1012;
    public const int EMAIL_BODY = 1013;
    public const int EMAIL_SUBJECT = 1014;
